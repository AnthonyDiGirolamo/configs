...
[core]
as_active_plugins = core;ccp;move;resize;place;decoration;mousepoll;session;neg;dbus;vpswitch;gnomecompat;imgjpeg;text;commands;png;snap;regex;svg;workarounds;animation;wall;expo;resizeinfo;fade;ezoom;staticswitcher;scale;scaleaddon;
...
as_close_window_key = <Shift><Alt>c
