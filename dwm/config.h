...
static const char normbordercolor[] = "#073642"; // brblack SOLARIZED
...
/* commands */
static const char *dmenucmd[] = { "dmenu", "-l", "2", "-i", "-fn", font, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbgcolor, "-sf", selfgcolor, NULL };
